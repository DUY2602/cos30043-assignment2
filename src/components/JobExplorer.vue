...
<template>
  <div class="job-explorer">
    <div class="job-explorer-header">
      <h2>Job Explorer</h2>
      <p>Browse and explore available positions. Select a job to view details.</p>
    </div>
    <div class="row g-3 align-items-stretch">
      ...
      <div class="col-md-6 col-lg-6">
        <div v-if="selectedJobId" class="detail-panel h-100">
          <JobDetail :job="jobs.find(j => j.job_id === selectedJobId)" />
        </div>
        <div v-else class="detail-panel h-100">
          <JobOverview />
        </div>
      </div>
    </div>
...
.job-explorer-header h2 {
  font-weight: 700;
  color: #1a1d20;
  margin-bottom: 0.25rem;
}
.job-explorer-header p {
